...
// ************************************************************************************
// 128-bit AVX implementation
template<>
size_t CountEOLs128<instruction_set_t::avx>(uchar_t *ptr, size_t size)
{
	if (size < 128)
...
// 128-bit AVX implementation
template <>
size_t CountMismatches128<instruction_set_t::avx>(uchar_t* p, uchar_t* q, size_t size)
{
	Vec16uc v_p, v_q;
	size_t rest = size % 16;
	size_t r = 0;
...
// 128-bit AVX implementation
template <>
void PrefetchDecompressed128<instruction_set_t::avx>(uchar_t* dest, uchar_t* src, uint32_t size, bool first_single_byte)
{
