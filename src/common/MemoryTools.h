...
#if defined WINDOWS
	static ::size_t processCurrentWorkingSet() { return WindowsMemoryTools::processCurrentWorkingSet(); }
	static ::size_t processPeakWorkingSet() { return WindowsMemoryTools::processPeakWorkingSet(); }
...
#elif defined LINUX
	static ::size_t processCurrentWorkingSet() { return UnixMemoryTools::processCurrentWorkingSet(); }
	static ::size_t processPeakWorkingSet() { return UnixMemoryTools::processPeakWorkingSet(); }
